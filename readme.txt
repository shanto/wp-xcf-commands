...
Tags: scf, acf, commands, gutenberg, site-editor
...
**XCF Commands** is a free WordPress plugin that adds a set of new search results to the site editor command palette (CMD+K/Ctrl+K) for all items filed under custom types except for those ignored from the settings page.

== Installation ==

### Manual

* Upload the XCF Commands folder to the plugins directory in your WordPress installation
* Activate the plugin.
* Custom post types will start appearing in the command palette immediately.
* See **Settings** → **XCF Commands** for customization options.
