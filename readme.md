...
Using it is very easy. Just search for "XCF Commands" in WordPress plugin directory, or download a copy from the Github repo. Install, and activate. That's it! If necessary, visit **Settings** → **XCF Commands** to exclude the types you want not to appear in the command palette.
